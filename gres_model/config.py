...
def add_maskformer2_config(cfg):
    ...
    cfg.SOLVER.RESTART_ITER = []
    cfg.SOLVER.START_ITER = 0
    cfg.SOLVER.END_ITER = 0
    ...
    cfg.CE_final_WEIGHT = -1.0
    cfg.CE_intermedia_WEIGHT= -1.0
    cfg.CE_nt_WEIGHT= -1.0
    cfg.Dice_final_WEIGHT= -1.0
    cfg.Dice_intermedia_WEIGHT= -1.0
def add_refcoco_config(cfg):
    ...
    cfg.DATASETS.LMDB_ROOT = '/data/lwz/MABP/gres_model/data/datasets/lmdb'
