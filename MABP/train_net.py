    ...
    def build_optimizer(cls, cfg, model):
        ...
        for module_name, module in model.named_modules():
            for module_param_name, value in module.named_parameters(recurse=False):
                ...
                # if module_name.startswith('sem_seg_head.predictor.decoder_norm'):
                #     #print(4)
                #     if not module_name.startswith('sem_seg_head.predictor.decoder_norm.3'):
                #         hyperparams["lr"] = 0.3 * cfg.SOLVER.BASE_LR

                # if module_name.startswith('sem_seg_head.predictor.mask_embed'):
                #     #print(3)
                #     if not module_name.startswith('sem_seg_head.predictor.mask_embed.3'):
                #         hyperparams["lr"] = 0.3 * cfg.SOLVER.BASE_LR
