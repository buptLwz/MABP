...
def add_maskformer2_config(cfg):
    ...
    cfg.MODEL.MASK_FORMER.A_WEIGHT = 1.0
    cfg.MODEL.MASK_FORMER.B_WEIGHT = 1.0
    cfg.MODEL.MASK_FORMER.C_WEIGHT = 20.0
    cfg.MODEL.MASK_FORMER.D_WEIGHT = 20.0
    cfg.MODEL.MASK_FORMER.E_WEIGHT = 20.0
